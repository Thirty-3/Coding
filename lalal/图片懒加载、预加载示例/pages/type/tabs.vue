<template>
    <view id="tabs-page">
        <tabs :name="name":change="tabChange">
            <!-- tab-0 -->
            <view v-show="curIndex === 0">
                <scroll-view :id="name[0]" scroll-y @scroll="scroll">
                    <lazy-load v-for="uri of list[0]" :key="uri" :scroll-id="'#'+name[0]" :src="uri" mode="widthFix"></lazy-load>
                </scroll-view>
            </view>
